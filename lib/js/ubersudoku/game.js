Game = {
    ...
    tiles: [],
    selectorTiles: [],
    difficulty: 0,//difficulty ranges from 1-8. 0 is solved, 9 is completely empty
        ...
        if (hasErrors == true) {
            ...
            if (this.tileValues.indexOf(0) > -1) {
                ...
                $('#game').fadeOut("slow", function () {
                    ...
                    $('#game-over').append('<p>Congratulations. You have won, I hope you enjoyed my game, and I look forward to hearing frou you soon. Thanks again for playing </p>');
